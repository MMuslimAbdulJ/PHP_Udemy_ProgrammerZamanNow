...
use OpenDebugger62\Test\ProductService;
...
class ProductServiceMockTest extends TestCase {
    ...
    public function testDelete(){
        ...
        $this->repository->expects($this->once())->method("findById")->willReturn($product)->with(self::equalTo("1"));
    ...
    public function testDeleteFailed() {
        ...
        $this->repository->expects($this->once())->method("findById")->willReturn(null)->with(self::equalTo("1"));
